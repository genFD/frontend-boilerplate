...
export const Landing = () => {
  ...
  return (
    <>
      {/* <Head description="Welcome to Feedbacks App" /> */}
      <h1>Welcome to Feedbacks App</h1>
      <div className="bg-white h-[100vh] flex items-center">
        <div className="max-w-7xl mx-auto text-center py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            <span className="block">Feedbacks app</span>
          </h2>
          {/* <img src={logo} alt="react" /> */}
          <p>logo</p>
          <p>Feedbacks description</p>
          <button onClick={() => setTest(!test)}> toggle test</button>
